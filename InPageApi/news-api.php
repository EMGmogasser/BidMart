...
// Set charset to utf8mb4 (supports emojis)
...
try {
    ...
    // Query to fetch paginated news
    $query = "SELECT NEWS_ID, CONTENT, LINK, ACTIVE FROM NEWS LIMIT ? OFFSET ?";
